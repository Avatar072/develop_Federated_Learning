...
for again in range(again_epoch): 
    ...
    x_train = np.loadtxt("Thursday_x_train_1.txt")
    y_train = np.loadtxt("Thursday_y_train_1.txt")
    x_test = np.loadtxt("Thursday_x_test_1.txt")
    y_test = np.loadtxt("Thursday_y_test_1.txt")
    print(x_train.shape)
    print(x_test.shape)
    print(y_train.shape)
    print(y_test.shape)
